...
class Event(models.Model):
	...
	image = models.ImageField(validators = [image_restriction], default = 'default.jpg', upload_to = 'event_pictures', blank=True)
...
class Question(models.Model):
	...
	flag = models.CharField(max_length=1, choices=QUESTION_FLAGS, default='U')
